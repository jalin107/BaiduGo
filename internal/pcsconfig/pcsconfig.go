...
var (
	...
	configFileName = pcsutil.ExecutableUserJoin("pcs_config.json")
...
func NewConfig() *PCSConfig {
	return &PCSConfig{
		...
		CacheSize:      1024,
		MaxParallel:    100,
		SaveDir:        pcsutil.ExecutablePathJoin("BaiduDownload"),
	}
}
...
func loadConfig() error {
	...
	// 下载目录为空处理, 旧版本兼容
	if Config.SaveDir == "" || Config.SaveDir == "BaiduDownload" {
		Config.SaveDir = pcsutil.ExecutablePathJoin("BaiduDownload")
	}
